...
#include <string.h>
#define N 15
//number of seconds between two reading and  sending : N

#define THIS_SENSOR_ID 2 //!!!!!!!!CAUTION: CHANGE THIS FOR EACH NODE MANUALLY!!!!!!!!!
//this macro is the only difference with file sensor1_zoul.c
